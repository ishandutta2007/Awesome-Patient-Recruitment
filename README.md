...
<p align="center">
  <img src="assets/banner.svg" alt="Awesome Patient Recruitment Banner" width="100%"/>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/ishandutta2007/Awesome-Patient-Recruitment/stargazers"><img src="https://img.shields.io/github/stars/ishandutta2007/Awesome-Patient-Recruitment?style=flat-square&logo=github&color=gold" alt="Stars"/></a>
  <a href="https://github.com/ishandutta2007/Awesome-Patient-Recruitment/network/members"><img src="https://img.shields.io/github/forks/ishandutta2007/Awesome-Patient-Recruitment?style=flat-square&logo=github&color=blue" alt="Forks"/></a>
  <a href="https://github.com/ishandutta2007/Awesome-Patient-Recruitment/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-green.svg?style=flat-square" alt="License"/></a>
...
```mermaid
flowchart TD
    A[📋 Clinical Trial Protocol] --> B[🔍 Extract Inclusion & Exclusion Criteria]
    B --> C[⚙️ Structured Eligibility Criteria Rules]

    D[🏥 Clinical Data Sources] --> E[💾 EHR / FHIR / OMOP Database]
    E --> F[👥 Cohort Discovery & Phenotyping]

    C --> F

    F --> G[🎯 Potential Candidate Cohort]
    G --> H[🔒 Privacy & Governance Review]
    H --> I[👨‍⚕️ Research Coordinator Review]

    I --> J[📬 Patient Outreach & Invitation]
    J --> K[📝 Prescreening Questionnaire]

    K --> L{Potentially Eligible?}
    L -->|❌ No| M[📁 Document Screen Failure Reason]
    L -->|✅ Yes| N[🏥 Study Site Clinical Screening]

    N --> O[✍️ eConsent & Verification]
    O --> P[🎉 Study Enrollment & Trial Visit]
```
...
flowchart LR
    ...
    D[📜 Clinical Trial Registry] --> E[🏷️ Trial Metadata & Criteria]
    E --> F[🤖 Eligibility Matching Engine]

    C --> F
    F --> G[👥 Candidate Cohort]
    G --> H[👨‍⚕️ Research Team Review]
    H --> I[📋 Prescreening Forms]
    I --> J[⚡ Workflow Automation]
    J --> K[💬 Participant Outreach]
    K --> L[✍️ Enrollment]
    L --> M[📦 OpenClinica / EDC]
...
erDiagram
    ...
    PATIENT ||--o{ LAB_RESULT : produces
    PATIENT ||--o{ CANDIDATE : becomes
    CLINICAL_TRIAL ||--|{ ELIGIBILITY_RULE : defines
    CLINICAL_TRIAL ||--|{ STUDY_SITE : operates_at
    CANDIDATE }|--|| CLINICAL_TRIAL : matches_to
    CANDIDATE ||--o{ PRESCREENING : completes
    CANDIDATE ||--o{ CONSENT : signs
    CANDIDATE ||--o{ ENROLLMENT : achieves
```
...
```mermaid
flowchart LR
    A[📐 Study Design] --> B[🏷️ Eligibility Definition]
    ...
    F --> G[📝 Prescreening]
    G --> H[🏥 Site Screening]
    H --> I[✍️ Informed Consent]
    I --> J[🎉 Study Enrollment]
    J --> K[🤝 Participant Retention]
```
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Patient-Recruitment&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Patient-Recruitment&type=date&legend=top-left)
